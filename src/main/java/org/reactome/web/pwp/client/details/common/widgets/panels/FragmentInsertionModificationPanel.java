...
import org.reactome.web.pwp.client.common.model.classes.FragmentInsertionModification;
...
public class FragmentInsertionModificationPanel extends DetailsPanel {
    ...
    private void initialize(){
        ...
        this.fragmentInsertionModification.load(new DatabaseObjectLoadedHandler() {
            @Override
