package org.reactome.web.elv.client.details.tabs.analysis.view.widgets.summary;
...
import org.reactome.web.elv.client.common.analysis.model.AnalysisSummary;
import org.reactome.web.elv.client.common.analysis.model.ResourceSummary;
import org.reactome.web.elv.client.details.tabs.analysis.view.style.AnalysisTabStyleFactory;
...
public class AnalysisSummaryPanel extends DockLayoutPanel {
    ...
    public AnalysisSummaryPanel(AnalysisResult analysisResult) {
        ...
        fp.addStyleName(AnalysisTabStyleFactory.getAnalysisStyle().analysisTabSummary());
    ...
    private Widget getResourceTypePanel(List<ResourceSummary> resourceSummary){
        ...
        resourcePanel.addStyleName(AnalysisTabStyleFactory.getAnalysisStyle().analysisTabSummaryInfo());
        resourcePanel.add(new InlineLabel("Results for: "));
        ListBox resourceBox = new ListBox(false);
    ...
    private Widget getTypePanel(AnalysisSummary summary){
        ...
        typePanel.addStyleName(AnalysisTabStyleFactory.getAnalysisStyle().analysisTabSummaryInfo());
    ...
    private Widget getOptionPanel(AnalysisSummary summary){
        ...
        optPanel.addStyleName(AnalysisTabStyleFactory.getAnalysisStyle().analysisTabSummaryInfo());
