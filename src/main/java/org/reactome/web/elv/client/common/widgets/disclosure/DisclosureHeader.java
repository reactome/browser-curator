package org.reactome.web.elv.client.common.widgets.disclosure;
...
public class DisclosureHeader extends Composite implements OpenHandler<DisclosurePanel>, CloseHandler<DisclosurePanel> {
    ...
    public interface Style extends CssResource {
         ...
         */
        String DEFAULT_CSS = "org/reactome/web/elv/client/common/widgets/disclosure/css/DisclosureHeader.css";
    ...
    private Button getIcon(ClickHandler instanceSelector){
        ...
        if(instanceSelector!=null){
            ...
            ImageResource ir = InstanceTypeIconProvider.getItemIcon(schemaClass);
